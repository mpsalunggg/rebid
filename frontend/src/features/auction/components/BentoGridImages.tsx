...
export default function BentoGridImages({
  ...
  if (imageCount === 1) {
    return (
      <div className="w-full h-72 overflow-hidden border rounded-lg flex justify-center bg-gray-100 dark:bg-gray-800">
        <img
  ...
  if (imageCount === 2) {
    return (
      <div className="grid grid-cols-2 gap-2 w-full h-72">
        <div className="overflow-hidden border rounded-lg h-full">
          <img
            src={`${BASE_URL}/${images[0].url}`}
            alt="Auction item"
  ...
  return (
    <div className="grid grid-cols-2 grid-rows-2 gap-2 w-full h-72">
      <div className="row-span-2 overflow-hidden rounded-lg border bg-gray-100 dark:bg-gray-800">
        <img
          src={`${BASE_URL}/${images[0].url}`}
          alt="Auction item"
          className="w-full h-full object-cover object-center"
      ...
      <div className="relative overflow-hidden border rounded-lg h-full">
        <img
